...
[![npm (scoped)](https://img.shields.io/npm/v/%40fission-codes/channel)](https://www.npmjs.com/package/@fission-codes/channel)
[![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/fission-codes/stack/channel.yml)](https://github.com/fission-codes/stack/actions/workflows/channel.yml)
...
```bash
pnpm install @fission-codes/channel
```
